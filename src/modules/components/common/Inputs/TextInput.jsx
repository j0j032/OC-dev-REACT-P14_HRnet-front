...
export const TextInput = React.forwardRef((props, ref) => {
	...
	const {label = true, inputName, errorDisplay, errors, ...otherProps} = props
	
	return (
		<div className='input__wrapper create-employee__input-wrapper'>
			{label && <label className='input-label' htmlFor={inputName}>{capitalize(inputName)}<span> *</span></label>}
